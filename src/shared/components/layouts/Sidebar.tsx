    ...
    >
      ...
      <nav className="mt-8 px-4 flex-1">
        <Link
          ...
          } p-3 rounded-lg mb-2 ${isActive(ROUTES.DASHBOARD)}`}
          title="Home"
        >
        ...
        <Link
          ...
          className={`flex items-center ${
            isCollapsed ? "justify-center" : "space-x-2"
          } p-3 rounded-lg mb-2 ${isActive(ROUTES.MY_PROFILE)}`}
          title="My Profile"
        >
        ...
        {canAccessMyStudents && (
          <Link
            ...
            className={`flex items-center ${
              isCollapsed ? "justify-center" : "space-x-2"
            } p-3 rounded-lg mb-2 ${isActive(ROUTES.MY_STUDENTS)}`}
            title="My Students"
          >
        ...
        {canAccessSupervisor && (
          <Link
            ...
            className={`flex items-center ${
              isCollapsed ? "justify-center" : "space-x-2"
            } p-3 rounded-lg mb-2 ${isActive(ROUTES.SUPERVISOR)}`}
            title="Supervisor"
          >
        ...
        {isHOD && (
          <Link
            ...
            className={`flex items-center ${
              isCollapsed ? "justify-center" : "space-x-2"
            } p-3 rounded-lg mb-2 ${isActive(ROUTES.DEPARTMENT_FACULTY)}`}
        ...
        {isStudent && (
          <>
            <Link
              ...
              className={`flex items-center ${
                isCollapsed ? "justify-center" : "space-x-2"
              } p-3 rounded-lg mb-2 ${isActive(ROUTES.CURRENT_SCHOLARSHIP)}`}
            ...
            <Link
              ...
              className={`flex items-center ${
                isCollapsed ? "justify-center" : "space-x-2"
              } p-3 rounded-lg mb-2 ${isActive(ROUTES.PREVIOUS_SCHOLARSHIPS)}`}
